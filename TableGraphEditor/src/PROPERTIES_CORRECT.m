%% PROPERTIES_CORRECT Правильное объявление Properties
...
%
%   ВАЖНО: SetAccess = public позволяет helper функциям устанавливать свойства

% Application data and state
% ВАЖНО: Нельзя использовать Access и SetAccess одновременно!
% Используем только SetAccess = public для возможности записи из helper функций
